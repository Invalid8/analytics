...
const Navigator = ({ tabOpen, setTab, full, setFull }) => {
  ...
  return (
    ...
    >
      <div
        className={`tube flex flex-col justify-between ${
          full ? "" : "items-center"
        } p-[1.55rem] bg-[#F7F8FA] dark:bg-[#171515] h-full overflow-y-auto overflow-x-hidden custom-scroll-bar gap-[2rem]`}
      >
        <div
          className={`top flex flex-col ${
            full ? "" : "items-center"
          } items-center gap-[1.25rem]`}
        >
          <Iconic
            className={`logo overflow-hidden ${
              full
                ? "straight w-100 items-start justify-start mb-2"
                : "w-[2.5rem] h-[2.5rem]"
            }`}
            onClick={() => {
          ...
          >
            <img src="/turbo.svg" className="w-[90%]" alt="..." />
            {full && <span className="text-lg font-bold">GeegPay</span>}
          </Iconic>
          <div
            className={`others flex flex-col ${
              full ? "" : "items-center"
            } gap-[1rem]`}
          >
            <Iconic
              className={`${full && "straight"} active category-btn`}
              title="categories"
            >
              <svg
        ...
        >
          <Iconic
            className={`expand-btn ${full && "straight"}`}
            title="expand"
          ...
          >
            ...
            {full && <span>Expand</span>}
          </Iconic>
          <Iconic
            className={`settings-btn ${full && "straight"}`}
            title="settings"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
