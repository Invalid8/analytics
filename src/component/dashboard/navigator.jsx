      ...
      <div className="tube flex flex-col justify-between items-center p-[1.25rem] bg-[#F7F8FA] dark:bg-[#171515] h-full overflow-y-auto overflow-x-hidden custom-scroll-bar gap-[2rem]">
        <div className="top flex flex-col items-center gap-[1.25rem]">
          ...
          <div className="others flex flex-col items-center gap-[1rem]">
            ...
            <Iconic className="trend-btn" title="Trend">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <Iconic className="profile-btn" title="profile">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <Iconic className="box-btn" title="box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <Iconic className="discount-btn" title="discount">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <Iconic className="info-btn" title="info">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <div className="theme">
              <div
                className={`join flex flex-col justify-center items-center gap-[1rem] rounded-[6.25rem] bg-[#fff] dark:bg-[#1c1919] dark:text-[#fff] p-[0.5rem]`}
              >
                <Iconic
                  className="light-btn"
                  title="light"
                ...
                >
                  <span
                    className={`"circle w-full h-full ${
        ...
        <div className="bottom flex flex-col items-center gap-[1.25rem]">
          ...
          <Iconic className="settings-btn" title="settings">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <Iconic className="logout-btn" title="logout">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
